...
```shell script
45 23 * * 6 conda activate TGI; cd /home/myname/TGI_scripts; python /home/myname/TGI_scripts/crawl_and_write_to_db.py aldisued > /home/myname/TGI_scripts/aldisued.log 2>&1
```
